// src/types/maturity-model.ts

/**
 * Interface pour les fonctions d'évaluation (domaines d'expertise)
 */
export interface Fonction {
  ...
  /**
   * Interface pour les thématiques d'évaluation
   */
  ...
  /**
   * Interface pour les niveaux globaux de maturité par fonction
   */
  ...
  /**
   * Interface pour les niveaux de maturité par thématique
   */
  export interface NiveauThematique {
    id: string;
    fonction: string;
    thematique: string;
    score_min: number;
  ...
  export interface ResultatEvaluation {
    ...
    date_analyse: Date;
    resultatsThematiques: ResultatThematique[];
  }
  
  /**
   * Interface pour les résultats par thématique
   */
  export interface ResultatThematique {
    id_score: string;
    id_analyse: string;
    thematique: string;
    score: number;
  ...
  export const THEMATIQUES_DEVSECOPS: Thematique[] = [
    { 
  ...
  export const THEMATIQUES_CYBERSECURITE: Thematique[] = [
    { 
      id: "cyber_governance", 
  ...
  export const THEMATIQUES_MODELE_OPERATIONNEL: Thematique[] = [
    { 
      id: "ops_structure", 
  ...
  export const THEMATIQUES_GOUVERNANCE_SI: Thematique[] = [
    { 
      id: "gouv_alignment", 
  ...
  export const THEMATIQUES_ACCULTURATION_DATA: Thematique[] = [
    { 
      id: "data_strategy", 
  ...
  export const NIVEAUX_GLOBAUX_DEVSECOPS: NiveauGlobal[] = [
    {
      id: "devsecops_n1",
      fonction: "devsecops",
      score_min: 0,
  ...
  export const NIVEAUX_GLOBAUX_CYBERSECURITE: NiveauGlobal[] = [
    {
      id: "cyber_n1",
  ...
  export const NIVEAUX_GLOBAUX_MODELE_OPERATIONNEL: NiveauGlobal[] = [
    {
      id: "ops_n1",
  ...
  export const NIVEAUX_GLOBAUX_GOUVERNANCE_SI: NiveauGlobal[] = [
    {
      id: "gouv_n1",
  ...
  export const NIVEAUX_GLOBAUX_ACCULTURATION_DATA: NiveauGlobal[] = [
    {
      id: "data_n1",
  ...
  // Configuration des niveaux thématiques pour DevSecOps
  export const NIVEAUX_THEMATIQUES: NiveauThematique[] = [
    ...
    // Gestion des vulnérabilités & Sûreté du code
    {
      ...
      // Thematiques des autres fonctions
  ...
  // Initialisation des FONCTIONS avec les thématiques et niveaux correspondants
  // Fonction pour initialiser la structure complète
  export function initializeMaturityModel() {
  ...
  export const MATURITY_MODEL = initializeMaturityModel();
